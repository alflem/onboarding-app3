...
const translations: Record<Language, Record<TranslationKey, string>> = {
  sv: {
    ...
    theme: 'Tema',
    language: 'Språk',
    onboarding_platform: 'Onboardingapp',
    platform_intro: 'Vår onboardingapp hjälper nya medarbetare att komma igång på ett smidigt och strukturerat sätt.',
    ...
    // Home page
    welcome_to_platform: 'Välkommen till onboardingappen!',
    ...
    remaining: 'återstår',
    benefits: 'Fördelar',
    why_use_platform: 'Varför använda vår onboardingapp',
    ...
    buddy_progress: 'Din buddyfremgang',
    completed_buddy_tasks_desc: 'Du har slutfört {progress}% av buddyoppgifterna',
    ...
    manage_employees_and_buddy: 'Hantera medarbetare och buddytilldelningar',
    ...
    onboarding_status_buddy: 'Onboarding-status och buddyhantering',
    ...
    configure_buddy: 'Konfigurera buddyfunktionen för din organisation',
  ...
  no: {
    ...
    language: 'Språk',
    onboarding_platform: 'Onboardingapp',
    platform_intro: 'Vår onboardingapp hjelper nye medarbeidere med å komme i gang på en smidig og strukturert måte.',
    ...
    // Home page
    welcome_to_platform: 'Velkommen til onboarding-appen!',
    ...
    remaining: 'gjenstår',
    benefits: 'Fordeler',
    why_use_platform: 'Hvorfor bruke vår onboarding-app',
    ...
    manage_employees_and_buddy: 'Håndter ansatte og buddytildelinger',
    ...
    onboarding_status_buddy: 'Onboarding-status og buddyhåndtering',
    ...
    configure_buddy: 'Konfigurer buddyfunksjonalitet for din organisasjon',
  ...
  en: {
    ...
    language: 'Language',
    onboarding_platform: 'Onboardingapp',
    platform_intro: 'Our onboarding app helps new employees get started in a smooth and structured way.',
    need_help: 'Need help?',
    support: 'Support',
    intranet: 'Intranet',
    ...
    // Home page
    welcome_to_platform: 'Welcome to the onboarding app!',
    ...
    remaining: 'remaining',
    benefits: 'Benefits',
    why_use_platform: 'Why use our onboarding app',
